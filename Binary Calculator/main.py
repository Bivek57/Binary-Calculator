...
while (Input==True):
    try:
        ...
        while (Range==True):
            print("")
            n1=int(input("Please enter the first number in Range of 0-255: "))
            print("")
        ...
        while (Range==True):
            print("")
            n2=int(input("Please enter the second number in Range of 0-255: "))
            print("")
        ...
        if n1 + n2>255:
            print ("Error ! This program can only run 8-bit Operations.")
